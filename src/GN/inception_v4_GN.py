...
def ghost_Inc_v4(num_classes=1000, pretrained='imagenet'):
    if pretrained:
...
if __name__ == '__main__':
    ...
    assert ghost_Inc_v4(num_classes=10, pretrained=None)
    print('success')
    assert ghost_Inc_v4(num_classes=1000, pretrained='imagenet')
    print('success')
    assert ghost_Inc_v4(num_classes=1001, pretrained='imagenet+background')
    print('success')

    # fail
    assert ghost_Inc_v4(num_classes=1001, pretrained='imagenet')
